...
func main() {
	...
	flag.StringVar(&httpServerAddr, "http-server-bind-address", ":8080", "The address the http server binds to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1433d88a.github.com",
	...
	// init istio client
	ic, err := versionedclient.NewForConfig(ctrl.GetConfigOrDie())
	if err != nil {
